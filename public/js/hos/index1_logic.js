...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // LocalStorage bookmark handlers
    function saveBookmarkState(problemId, isBookmarked) {
        try {
            let bookmarks = JSON.parse(localStorage.getItem('hos_bookmarks') || '[]');
            ...
            localStorage.setItem('hos_bookmarks', JSON.stringify(bookmarks));
        } catch (e) { console.error('Error saving bookmark state', e); }
    }

    function initBookmarks() {
        try {
            const bookmarks = JSON.parse(localStorage.getItem('hos_bookmarks') || '[]');
            ...
            allProblemsRows.forEach(row => {
                ...
                if (bookmarks.includes(id)) {
                    ...
                    // Clone to bookmark tab
                    addToBookmarkedTab(row);
                }
            });
        } catch (e) { console.error('Error init bookmarks', e); }
    }
